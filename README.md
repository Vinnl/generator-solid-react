...
Once you've [run the generator](#installation-and-usage) and created your starter application, you'll have a site with some basic functionality and style guide integration. As the SDK is continually evolving, take a look at the [Solid React SDK by inrupt](https://github.com/inrupt/solid-react-sdk) [Release Timeline](https://github.com/Inrupt/solid-react-sdk/tree/master#release-timeline) for what has been implemented and what is currently planned.
